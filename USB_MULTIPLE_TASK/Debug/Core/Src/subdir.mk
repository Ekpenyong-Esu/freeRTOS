...
./Core/Src/VirtualCommDriverMultiTask.d \
./Core/Src/main.d \
...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/STM32_Disc1_Gpio.cyclo ./Core/Src/STM32_Disc1_Gpio.d ./Core/Src/STM32_Disc1_Gpio.o ./Core/Src/STM32_Disc1_Gpio.su ./Core/Src/VirtualCommDriverMultiTask.cyclo ./Core/Src/VirtualCommDriverMultiTask.d ./Core/Src/VirtualCommDriverMultiTask.o ./Core/Src/VirtualCommDriverMultiTask.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_hal_timebase_tim.cyclo ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_hal_timebase_tim.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
